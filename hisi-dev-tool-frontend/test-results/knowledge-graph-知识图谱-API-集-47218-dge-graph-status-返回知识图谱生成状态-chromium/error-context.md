...
- Name: knowledge-graph.spec.ts >> 知识图谱 API 集成测试 >> GET /api/knowledge-graph/status >> 返回知识图谱生成状态
- Location: e2e\knowledge-graph.spec.ts:55:5
...
Received value: {"code": 200, "data": {"callChainCount": "0", "callRelationCount": 0, "dataModelCount": "0", "entryCount": "0", "entryPointCount": 0, "interfaceImplCount": 0, "methodNodeCount": 0, "projectPath": "/tmp/test-project", "status": "not_generated", "usesModelRelationCount": "0"}, "message": "success", "success": true}
```
