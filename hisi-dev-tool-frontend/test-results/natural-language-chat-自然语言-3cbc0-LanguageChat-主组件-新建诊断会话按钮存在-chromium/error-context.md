...
- Name: natural-language-chat.spec.ts >> 自然语言诊断组件测试 >> NaturalLanguageChat 主组件 >> 新建诊断会话按钮存在
- Location: e2e\natural-language-chat.spec.ts:31:5
...
Locator: locator('button:has-text("新建诊断会话")')
Expected: visible
Timeout: 5000ms
