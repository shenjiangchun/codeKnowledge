...
- Name: integration.spec.ts >> 智能诊断页面 >> 诊断页面加载
- Location: e2e\integration.spec.ts:42:3
...
Locator: locator('input, textarea').first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('input, textarea').first()
