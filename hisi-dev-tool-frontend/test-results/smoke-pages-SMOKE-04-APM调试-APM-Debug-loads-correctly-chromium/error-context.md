...
- Name: smoke-pages.spec.ts >> SMOKE-04: APM调试 (APM Debug) loads correctly
- Location: e2e\smoke-pages.spec.ts:135:1
    ...
    - main [ref=e76]:
      - generic [ref=e77]:
        - generic [ref=e78]:
          ...
          - generic [ref=e83]:
            - generic [ref=e84]:
              - generic [ref=e85]: 项目目录
              - generic [ref=e87]:
                - textbox "项目目录" [ref=e89]:
                  - /placeholder: 请输入项目代码存放目录
                  - text: C:\Users\47583\projects\hisi_dev_tool v4.0
                - button "选择目录" [ref=e92] [cursor=pointer]:
                  - generic [ref=e93]: 选择目录
            - generic [ref=e95]:
              - button "保存配置" [ref=e96] [cursor=pointer]:
                - generic [ref=e97]: 保存配置
              - button "重置" [ref=e98] [cursor=pointer]:
                - generic [ref=e99]: 重置
        - alert [ref=e100]:
          - img [ref=e102]
          - generic [ref=e105]: 请在表格中勾选一个或多个项目以开始分析
        - generic [ref=e108]:
          - tablist [ref=e112]:
            - tab "本地项目" [selected] [ref=e114]
            - tab "远端项目" [ref=e115]
          - tabpanel "本地项目" [ref=e117]:
            - generic [ref=e118]:
              - generic [ref=e119]: 项目管理
              - generic [ref=e120]:
                - button "项目分组" [ref=e121] [cursor=pointer]:
                  - generic [ref=e122]:
                    - img [ref=e124]
                    - text: 项目分组
                - button "一键更新所有仓库" [ref=e126] [cursor=pointer]:
                  - generic [ref=e127]:
                    - img [ref=e129]
                    - text: 一键更新所有仓库
                - button "扫描仓库" [disabled]:
                  ...
                  - generic:
                    - generic:
                      - img
                    - text: 扫描仓库
                - button "图谱屏蔽目录" [ref=e131] [cursor=pointer]:
                  - generic [ref=e132]:
                    - img [ref=e134]
                    - text: 图谱屏蔽目录
                - button "术语配置" [ref=e136] [cursor=pointer]:
                  - generic [ref=e137]:
                    - img [ref=e139]
                    - text: 术语配置
                - button "克隆项目" [ref=e141] [cursor=pointer]:
                  - generic [ref=e142]:
                    - img [ref=e144]
                    - text: 克隆项目
                - button "跨服务依赖构建 (0)" [disabled] [ref=e146]:
                  - generic [ref=e147]: 跨服务依赖构建 (0)
                - button "确认选择 (0)" [disabled] [ref=e148]:
                  - generic [ref=e149]:
                    - img [ref=e151]
                    - text: 确认选择 (0)
                - button "批量生成图谱 (0)" [disabled] [ref=e153]:
                  - generic [ref=e154]:
                    - img [ref=e156]
                    - text: 批量生成图谱 (0)
```
