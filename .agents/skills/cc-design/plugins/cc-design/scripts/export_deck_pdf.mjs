#!/usr/bin/env node
/**
 * export_deck_pdf.mjs — Export multi-file slide deck to a single vector PDF
 *
 * Usage:
 ...
 *   - Visual loss = 0 (PDF is exactly what the browser prints)
 *
 * Trade-off:
 *   - PDF text is not re-editable (go back to HTML for changes)
 *
