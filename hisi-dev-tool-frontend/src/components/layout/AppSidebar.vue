...
import { Document, Folder, Monitor, Shop, DataAnalysis, Setting } from '@element-plus/icons-vue'
...
type MenuKey = 'log-analysis' | 'project-management' | 'claude-terminal' | 'prompt-config' | 'skill-market' | 'knowledge-graph' | 'settings'
