...
- Name: natural-language-chat.spec.ts >> 自然语言诊断组件测试 >> NaturalLanguageChat 主组件 >> 点击开始自然语言诊断创建会话
- Location: e2e\natural-language-chat.spec.ts:74:5
...
Call log:
  - waiting for locator('button:has-text("开始自然语言诊断")')
